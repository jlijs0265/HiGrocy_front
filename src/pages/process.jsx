                ...
                <div className="col-md-6 stretch-card">
                  <div className="card">
                    <div className="card-body">
                      ...
                      <button className="btn btn-primary me-2" id="registerBtn">
                        등록
                      </button>
                      <button className="btn btn-success me-2" id="updateBtn">
                        수정
                      </button>
                      <button className="btn btn-danger me-2" id="deleteBtn">
                        삭제
                      </button>
                    </div>
                  </div>
